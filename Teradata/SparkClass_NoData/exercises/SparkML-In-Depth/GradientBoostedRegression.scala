...
// it as an RDD of LabeledPoint and then perform regression using
// Gradient-Boosted Trees with Squared Error as the loss. The Mean
// Squared Error (MSE) is computed at the end to evaluate goodness of
// fit.
